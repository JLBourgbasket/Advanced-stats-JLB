...
function buildSignals(metrics: TeamMetrics) {
  ...
  if (metrics.fgast >= 62) positives.push({ title: "Création collective", detail: `${formatMetric(metrics.fgast)}% des paniers de champ sont assistés.`, score: metrics.fgast - 62 });
