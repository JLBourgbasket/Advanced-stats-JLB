...
function buildSignals(metrics: TeamMetrics, players: AggregatedPlayer[], games: number) {
  ...
  if (metrics.fgast >= 62) threats.push({ title: "Création collective", detail: `${formatMetric(metrics.fgast)}% des paniers sont assistés.`, score: (metrics.fgast - 62) / 2 });
...
function buildGamePlan(metrics: TeamMetrics, players: AggregatedPlayer[]) {
  ...
  if (metrics.fgast >= 62) keys.push("Casser le rythme des premières passes et forcer davantage de création individuelle tardive.");
